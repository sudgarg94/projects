...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" id="my-navbar">
        ...
        </form> --><li><a href="<%=request.getContextPath()%>/MultipleQuerySearch.jsp">Perform Multiple Query <span class="sr-only">(current)</span></a></li>
 ...
 <div class="homepage-hero-module">
            <div class="video-container">
                ...
                <div class="col-md-8">
                    ...
                    <h2 style="color:white;">Perform Multiple Search</h2>
                </div>
                </div>
                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-4">
                                <input type="text" id="search" name="search" class="form-control" placeholder="Type Anything to Search" required>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col-md-4"></div>
                                <div class="col-md-4" id="sudhanshu" style="margin-top: 5px;">
                                &nbsp;	<input type="radio" name="multiple" value="AND" required><span style="color:white"> And</span> &nbsp;
                                <input type="radio" name="multiple" value="OR"> <span style="color:white">Or</span>&nbsp;
                                <input type="radio" name="multiple" value="NOT"><span style="color:white"> Not</span> 
                                </div>
                            </div>
                            ...
                            <div class="row">
                            	<div class="col-md-4"></div>
                            	<div class="col-md-4">
                            	<input type="text" id="search1" name="search" style="margin-top: 5px; width: 99%; margin-left: 5px;" class="form-control" 
...
<!-- Footer -->
 <div class="container-fluid footer-container">		
 	<div class="container" id="content">
            ...
            <br><br>
                            <div class="row">
                                <div class="col-md-5 text-info"  style="font-size: 15px !important;" ><b>AND</b> : Both Queries must be included</div>
                            </div>

                            <div class="row">
                                <div class="col-md-12 text-info" style="font-size: 15px !important;"  ><b>OR</b> &nbsp; : Either Query should be included</div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 text-info"  style="font-size: 15px !important;" ><b>NOT</b> : First Query must be included but without the Second</div>
                            </div>
            <div class="row">
                <div class="col-lg-12">
                	<center>
