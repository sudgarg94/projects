        ...
        <div class="row centered-form">
            <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-4	col-md-offset-3		">
                <!-- <div class="panel panel-default"> -->
                        ...
                        <h3 class="panel-title text-center">Job Seekers Register</h3>
                   
                    <div class="panel-body">
                        <form:form action="${contextPath}/user/registerJobSeeker" commandName="jobseeker" method="post">
                            <div class="form-group">
                            	<form:input path="firstName" size="30" required="required" placeholder="First Name" class="form-control input-md"/>
								<font color="red"><form:errors path="firstName" /></font>
                            </div>

                            <div class="form-group">
                                <form:input path="lastName" size="30" required="required" placeholder="Last Name" class="form-control input-md"/>
								<font color="red"><form:errors path="lastName" /></font>
                            </div>
                            
                            <div class="form-group">
                                <form:input path="emailID" size="30" required="required" placeholder="Email ID" class="form-control input-md"/>
