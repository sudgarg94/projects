        ...
        <div class="row centered-form">
            <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-4	col-md-offset-3		">
                <!-- <div class="panel panel-default"> -->
                        ...
                        <h3 class="panel-title text-center">Company Register</h3>
                   
                    <div class="panel-body">
                        <form:form action="${contextPath}/user/registerCompany" commandName="company" method="post">
                            <div class="form-group">
                            	<form:input path="companyName" size="30" required="required" placeholder="Company Name" class="form-control input-md"/>
